...
class GameplayScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.sparks = this.physics.add.sprite(80, game.config.height / 2, 'sparks')
    ...
    placeCars(addScore) {
        ...
        let carGapPosition = Phaser.Math.Between(gameOptions.minCarHeight + carGapHeight / 2, game.config.height - gameOptions.minCarHeight - carGapHeight / 2)
    ...
    update() {
        ...
        if (this.sparks.y > game.config.height || this.sparks.y < 0) {
            this.die()
        }
        this.carGroup.getChildren().forEach(function(car) {
